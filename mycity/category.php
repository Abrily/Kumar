...
<body>
 ...
 _________________________________________________________ -->
		...
		<a href="addCategory.php" class="btn btn-primary btn-sm">Add New Category</a>                
...
<?php 
	...
	while ($categoryRow =$categoryResult->fetch_array()) 
	{
		...
		$categoryImage =  $categoryRow['CategoryIconPath'];
		$OrderNo =  $categoryRow['OrderNo'];
		$categoryIconPath = "categoryIcon/".$categoryImage;
		...
		echo '<tr>
 			<td>'.$slNo.'</td>
		      <td>'.$OrderNo.'</td>
		      <td>';
						  if(file_exists($categoryIconPath)){

echo '<img src='.$categoryIconPath.' alt="No image">';
