            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">Business Developer List</a>
                        </li>
...
<ul class="nav nav-pills nav-stacked">
                ...
                <div class="col-md-9" id="customer-order">
                    <div class="box">
                        <h3>Business developer List</h3> 

		<a href="addBD.php" class="btn btn-primary btn-sm">Add Business developer</a>                
...
<?php 
	...
	$productQuery  = "SELECT * FROM businessdeveloper ORDER BY EmployeID ASC";
	...
	while ($productRow = $productResult->fetch_array()) 
	{
		...
		$AdminID =  $productRow['EmployeID'];
		$AdminName =  $productRow['Name'];
		$ProfileImage =  $productRow['ProfileImage'];
		$AdminEmailID =  $productRow['EmailID'];
		$CityName =  $productRow['CityName'];
...
$state='confirmed';
		...
		$profilIconPath = "businessDeveloper/".$ProfileImage;
