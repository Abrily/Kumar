...
$phoneNo =sanitizeString($_POST['phoneNo']);
	...
	$uploaddir      = "businessDeveloper/"; //location to store image
...
$status=0;
$sqlCheck="SELECT * FROM businessdeveloper "

        ."WHERE EmployeID='$adminID' AND Password='$password' "
...
if($resultCheck->num_rows > 0)
	...
	$message="<div class='alert alert-warning'><p>Error! developer name already existed</p></div>";
	...
	$mysqldate = $dateTime->format("Y-m-d H:i:s");
		//echo "INSERT INTO businessdeveloper(EmployeID,Password,Name,EmailID,CityName,ProfileImage,PhoneNo,DateTime) values('$adminID','$password','$adminName', '$emailID','$cityName','$categoryImageName','$phoneNo','$mysqldate')";

	$sqlAdd="INSERT INTO businessdeveloper(EmployeID,Password,Name,EmailID,CityName,ProfileImage,PhoneNo,Status,DateTime) values('$adminID','$password','$adminName', '$emailID','$cityName','$categoryImageName','$phoneNo','0','$mysqldate')";

$resultAdd=$conn->query($sqlAdd);
	
	if($resultAdd)
	{
		$message="<div class='alert alert-info'><p>Business developer added successfully!</p></div>";
		}
	else
	{
...
<body>
            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">Business Developer</a>
                        </li>
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-6" id="customer-order">
                    <div class="box">
                        <h3>Add Business developer </h3> 
                          <hr>
     				<span style="color:red" id="message"><?php echo $message; ?></span>

                        <form action="addBD.php" name="AddAdminForm"   onsubmit="return RegisterAdminFormValidation()"  method="post" enctype="multipart/form-data">

 	
			<div class="form-group">
                                <label for="adminID">Business developer ID</label>
...
<input type="text" class="form-control" id="adminID" name="adminIDName" required>
							...
							<div class="form-group">
                                <label for="password">Developer Name</label>
                                <input type="text" class="form-control" id="adminName" name="adminName">
     				</br><span style="color:red" id="adminNameErrID"></span>
                            </div>
                            <div class="form-group">
                                <label for="password">Developer Profile</label>
			...
			<div class="form-group">
                                <label for="password">Select City</label>
                                <select name="cityName" id="categoryNameID" class="form-control">
...
<?php 
	...
	$categoryQuery  = "SELECT * FROM cityName ORDER BY cityName ASC";
 	$categoryResult = $conn->query($categoryQuery);


	while ($categoryRow = $categoryResult->fetch_array()) 
	{
		$cityID =  $categoryRow['cityID'];
		$cityName =  $categoryRow['cityName'];
...
<div class="form-group">
                                ...
                                <input type="text" class="form-control" id="emailIDName" name="emailIDName" >
     				</br><span style="color:red" id="emailIDErrID"></span>
                            </div>
<div class="form-group">
                                <label for="password">Phone No</label>
                                <input type="text" class="form-control" id="phoneNo" name="phoneNo">
     				</br><span style="color:red" id="phoneErrID"></span>
                            </div>


                            <div class="text-center">
                                <button type="submit" class="btn btn-primary" name = "AddAdmin"><i class="fa fa-sign-in"></i>Add Business Developer</button>
